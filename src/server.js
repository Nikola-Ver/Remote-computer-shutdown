  ...
  socket.on("media", (data) => {
    ...
    if (command === "backward down") {
      if (idTimerBackward === 0) {
        exec(`start simulating_keystrokes/backward.vbs`, function (error, stdout, stderr) {});     
      ...
      exec(`start simulating_keystrokes/pause.vbs`, function (error, stdout, stderr) {});   
    }
    else if (command === "forwards down")  {
      if (idTimerForwards === 0) {
        exec(`start simulating_keystrokes/forwards.vbs`, function (error, stdout, stderr) {});     
